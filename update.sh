...
4)
sh -c "$(curl -fsSL https://gitlab.com/hp3icc/Easy-FreeDMR-SERVER-Install/-/raw/main/fdmr-update.sh)" ;;
5)
break;
esac
done
...
2)
sh -c "$(curl -fsSL https://gitlab.com/hp3icc/Easy-FreeDMR-SERVER-Install/-/raw/main/selfservice-update.sh)" ;;
3)
break;
esac
done
